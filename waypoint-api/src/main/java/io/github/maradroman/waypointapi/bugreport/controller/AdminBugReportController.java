...
public class AdminBugReportController {
    ...
    @GetMapping
    @Operation(summary = "List all bug reports",
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get bug report detail",
            description = "Returns a single bug report with metadata, reporter info, and attachments with presigned download URLs. Requires ADMIN role.")
    @ApiResponses({
    ...
    public ResponseEntity<ResponseEnvelope<AdminBugReportDetail>> getBugReportDetail(
