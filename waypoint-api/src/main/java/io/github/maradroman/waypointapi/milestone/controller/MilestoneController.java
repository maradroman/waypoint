...
public class MilestoneController {
    ...
    @PatchMapping("/{id}")
    @Operation(summary = "Update milestone", description = "Updates title, cost, details, or enabled status of a milestone")
    @ApiResponses({
    ...
    @Operation(summary = "Complete milestone", description = "Marks a milestone as completed and creates a completion record")
    @ApiResponses({
    ...
    public ResponseEntity<ResponseEnvelope<MilestoneResponse>> completeMilestone(
        ...
        return ResponseEntity.ok(ResponseEnvelope.of(
                milestoneService.getMilestoneWithBalance(user, goalId, id)));
    }

    @GetMapping("/{id}/transfers")
    @Operation(summary = "List milestone transfers", description = "Returns all transfers (allocations/withdrawals) for a milestone")
    @ApiResponses({
    ...
    public ResponseEntity<ResponseEnvelope<List<TransferResponse>>> listMilestoneTransfers(
        ...
        return ResponseEntity.ok(ResponseEnvelope.of(
                milestoneService.listMilestoneTransfers(user, goalId, id)));
    }
    ...
    public ResponseEntity<ResponseEnvelope<MilestoneResponse>> uncompleteMilestone(
        ...
        return ResponseEntity.ok(ResponseEnvelope.of(
                milestoneService.uncompleteMilestone(user, goalId, id)));
    }
    ...
    public ResponseEntity<ResponseEnvelope<MilestoneResponse>> toggleMilestone(
        ...
        return ResponseEntity.ok(ResponseEnvelope.of(
                milestoneService.toggleMilestone(user, goalId, id)));
    }
    ...
    public ResponseEntity<ResponseEnvelope<List<MilestoneResponse>>> reorderMilestones(
        ...
        return ResponseEntity.ok(ResponseEnvelope.of(
                milestoneService.reorderMilestones(user, goalId, request)));
    }
    ...
    public ResponseEntity<ResponseEnvelope<List<MilestoneResponse>>> toggleAllMilestones(
        ...
        return ResponseEntity.ok(ResponseEnvelope.of(
                milestoneService.toggleAllMilestones(user, goalId, enabled)));
    }
}
