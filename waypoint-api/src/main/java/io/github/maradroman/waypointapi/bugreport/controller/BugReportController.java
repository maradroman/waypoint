...
public class BugReportController {
    ...
    @PostMapping
    @Operation(summary = "Create bug report",
    ...
    @GetMapping
    @Operation(summary = "List bug reports",
    ...
    @Operation(summary = "Upload attachments",
            description = "Uploads screenshot or screen recording files to an existing bug report. Accepts multipart/form-data with one or more files.")
    @ApiResponses({
