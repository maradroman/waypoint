...
public record AdminBugReportDetail(
        @Schema(description = "Bug report UUID") UUID id,
        @Schema(description = "Bug description") String description,
        @Schema(description = "Reproduction metadata") Map<String, Object> metadata,
        @Schema(description = "Creation timestamp") Instant createdAt,
        @Schema(description = "Reporter user info") AdminBugReportListItem.ReporterInfo user,
    ...
    public record AttachmentWithUrl(
            @Schema(description = "Attachment UUID") UUID id,
