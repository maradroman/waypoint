...
public class AnalyticsController {
    ...
    @Operation(
            ...
            description = "Returns detailed analytics for a single goal including deposits, allocations, and progress")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Returns aggregate summary statistics across all goals for the authenticated user")
    @ApiResponses({
