...
public class TestDataMilestoneDto {
    ...
    public static MilestoneResponse milestoneResponse() {
        return new MilestoneResponse(MILESTONE_ID, GOAL_ID, MILESTONE_TITLE, MILESTONE_COST,
                MILESTONE_DETAILS, true, false, null, 0, 0,
                DEFAULT_TIMESTAMP, DEFAULT_TIMESTAMP);
    }

    public static MilestoneResponse milestoneResponse(UUID id, String title, int balance, int cost) {
        return new MilestoneResponse(id, GOAL_ID, title, cost,
                MILESTONE_DETAILS, true, false, null, 0, balance,
                DEFAULT_TIMESTAMP, DEFAULT_TIMESTAMP);
    }
